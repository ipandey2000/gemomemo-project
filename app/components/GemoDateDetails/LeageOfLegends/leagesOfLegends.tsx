        ...
        <div className="min-h-screen  text-white p-10">
            ...
            <div className="max-w-5xl mx-auto bg-black/80 p-8 rounded-lg shadow-lg">
                ...
                <div className="relative border ">
                    ...
                    {/* Release Date */}
                    <div className="absolute top-3 left-3 text-sm text-brown-300 border py-2 p-2" style={{ borderRadius: '20px', border: '1px solid gray' }}>
                ...
                {/* Champion Section */}
                <div className="mt-10 text-center">
                    <h2 className="text-4xl font-bold text-brown-500">CHOOSE YOUR <br /> CHAMPION</h2>
                    <p className="mt-4 text-lg">
