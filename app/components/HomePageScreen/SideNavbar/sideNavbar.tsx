...
const Sidebar = () => {
  return (
    <div className="h-screen w-16 text-white flex flex-col ">
      <div className="flex-grow">
        <ul className="mt-10">
          {/* You can uncomment this line and add a logo image if needed */}
          {/* <img src='' alt="logo" className="h-10 w-10 mx-auto" /> */}
